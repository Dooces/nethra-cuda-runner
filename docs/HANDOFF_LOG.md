# Nethra session log (verbatim, newest first)

This is the full record of the sessions of 2026-09-25 (third to fifth; the second session is §1-§10).
The current state and the instructions are in `docs/HANDOFF.md`; it points here by section number.
Nothing below was edited when the log was split off, except this header and the two notes marked
"(note added ...)".

(note added 2026-09-25, end of fifth session) The comparisons with people in §0g.3, §0g.4 and §0h.3
were written before the user clarified the bar. Read them through `docs/HANDOFF.md` §2: people's
...
(note added when the log was split off) Full grid of the session, 5 features / 10 contexts
(`regimes.py P=5 K=10 BLK=30`) and graded ring 12 positions / 8 cells, 20 laps (`direction_motion.py`):

| VAR | 5 feat / 10 ctx | ring centre shift | intervals forward /24 | gain ahead / behind |
|---|---|---|---|---|
| none (split) | 0.78 | +0.207 | 24 | 0.81 / 0.19 |
| on | 0.80 | +0.218 | 24 | 0.83 / 0.17 |
| in | 0.74 | +0.200 | 24 | 0.82 / 0.18 |
| on+in (neg) | 0.76 | +0.213 | 24 | 0.84 / 0.16 |
| op | 0.90 | +0.141 | 21 | 0.68 / 0.32 |
| ip | 0.80 | +0.156 | 18 | 0.76 / 0.24 |
| on+in+op | 0.88 | +0.110 | 18 | 0.68 / 0.32 |
| on+in+ip | 0.95 | +0.143 | 18 | 0.77 / 0.23 |
| op+ip | 0.99 | +0.023 | 10 | 0.62 / 0.38 |
| on+in+op+ip (= shared evidence) | 1.00 | -0.085 | 8 | 0.59 / 0.41 |
| persist | 0.78 | +0.251 | 24 | 0.78 / 0.22 |
| persist+on+in | 0.82 | +0.260 | 24 | 0.80 / 0.20 |
| UNI=1 | 0.17 (4 feat 0.22; 6 feat / 8 ctx 0.10) | +0.003 | 24 | total gain 0.0006 |
